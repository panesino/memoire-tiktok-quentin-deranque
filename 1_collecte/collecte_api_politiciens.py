# Collecte des vidéos des comptes de personnalités et partis politiques via la Research API de TikTok.
...
CHEMIN_SORTIE_JSON = ""  # à compléter : JSON de sortie de la collecte politiques
...
CHEMIN_ETAT = Path(__file__).parent / "collecte_tiktok_etat_politiciens.json"
...
║                                                                  ║
║  Le quota se renouvelle à 01:00 AM                               ║
║                                                                  ║
